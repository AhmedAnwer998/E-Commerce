...
const Cart = () => {
  ...
  return (
    <div className={`py-4  ${isDarkMode ? "bg-dark text-gray-300" : ""}`}>
      <Container>
        {cart.length === 0 ? (
          <h3
            ...
            {cart.map((product, index) => (
              <React.Fragment key={product.id}>
                <Row>
                  <Col xl={2} className="">
                    <div className=" h-52 w-52 flex items-center justify-center py-1">
                      <img
                        ...
                        className={`py-2 h-full object-contain bg-gray-200-300 ${isDarkMode ? "hover:bg-slate-700" : "hover:bg-slate-100"} duration-300 rounded-md transition-all`}
                      />
                    </div>
                  </Col>
                  <Col
                    xl={4}
                    className={`flex items-start justify-start bg-gray-200-300 ${isDarkMode ? "hover:bg-slate-700" : "hover:bg-slate-100"} duration-300 rounded-md transition-all`}
                  >
                  ...
                  <Col
                    xl={3}
                    className={`flex justify-end bg-gray-200-300 ${isDarkMode ? "hover:bg-slate-700" : "hover:bg-slate-100"} duration-300 rounded-md transition-all`}
                  >
                  ...
                  {index === 0 && (
                    <Col
                      xl={3}
                      className={`shadow-md ${isDarkMode ? "hover:bg-slate-800 hover:shadow-xl" : "hover:bg-slate-100 hover:shadow-xl"} transition-all duration-300 flex flex-col items-center rounded-lg`}
                    >
